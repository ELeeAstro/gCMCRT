...
# Need to manually add the gravity, Rd, and Rp (radius) in mks here 
g = 8.98
Rd = 3556.8
Rp = 9.865e7

# Hypsometric equation to find height grid (assumed gravity constant)
...
# Select time coordinate (usually -1 for last output)
it = -1
